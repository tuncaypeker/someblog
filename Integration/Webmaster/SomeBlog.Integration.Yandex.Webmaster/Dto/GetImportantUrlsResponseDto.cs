...
{
    public class ImportantUrlIndexingStatus
    {
    ...
    public class ImportantUrlSearchStatus
    {
    ...
    public class ImportantUrl
    {
        ...
        public ImportantUrlIndexingStatus indexing_status { get; set; }
        public ImportantUrlSearchStatus search_status { get; set; }
    }

    public class GetImportantUrlsResponseDto
{
        public List<ImportantUrl> urls { get; set; }
    }
